...
def main():
    ...
    obs = "IMD"
    model = "GEFS"
    domain = [67, 98, 7, 38] # west east south north
    season = "May-Sep"
    n_bootstraps = 10
    years = (2003, 2018)
    dir = 'Common Period/'
    ...
    plots.plot_rpss_deepnet(rpss_train_list, rpss_val_list, rpss_test_list, obs=obs, model=model, week=week, architecture=architecture, mask=mask
